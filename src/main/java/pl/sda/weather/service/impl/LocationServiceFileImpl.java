...
import pl.sda.weather.repository.impl.LocationRepositoryFileImpl;
...
public class LocationServiceFileImpl {
    ...
    LocationRepositoryFileImpl locationRepository = new LocationRepositoryFileImpl();
    ...
    public void cleanRecords() {
        this.locationRepository.delateAllRecordsInFile();
    }
